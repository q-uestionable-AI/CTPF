---
title: "Introduction"
description: "CTPF research harness for MCP observation and controlled fixtures"
---

## What is q-AI?

q-AI is a local **Capability Trust Propagation Failure (CTPF)** research harness.
...
equal product modules on the public `qai` CLI:

...
bundle declared by a governed single-run result. For a governed matrix, it requires a completed
series manifest bound to the immutable RunSpec and verifies the exact unique set of trial bundles
and result linkages. It does not establish independent authenticity, scientific validity, or
generality. Stable mechanical reason codes travel with the result; they are not human adjudication.
...
internal consistency and matrix result linkage only.
